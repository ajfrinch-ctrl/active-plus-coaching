...
- অফলাইন লগইন পেজ — **ইউজারনেম (বা মোবাইল নম্বর)** ও ৪–৬ সংখ্যার PIN। পেমেন্ট কাউন্টারের আলাদা লগইন `payment.html`-এ (`payment.apc`)
...
- **শুধু `payment.html`-এ লগইন** — শিক্ষার্থী লগইন পেজে পেমেন্ট ট্যাব বা অটো-লগইন নেই। কাউন্টারের ইউজারনেম **`payment.apc`**, পাসওয়ার্ড **`Apc@2026`**। ভুল হলে বাংলা ত্রুটি-বার্তা। “এই ডিভাইসে মনে রাখুন” চেক থাকলে সেশন ৯০ দিন, না হলে ট্যাব-সেশন। সেশন থাকলে ডেস্ক সরাসরি খোলে।
...
`teacher.html` খুলুন (অথবা এডমিন প্যানেল → আরও → শিক্ষক প্যানেল)। শিক্ষার্থী লগইন পেজে শিক্ষক প্যানেলের কোনো লিংক নেই। ইউজারনেম **`teacher.apc`**, পাসওয়ার্ড **`Apc@2026`**। এক ক্লিকে প্রবেশ নেই। ডেটা এই ব্রাউজারে থাকে; এটি সার্ভার-ভিত্তিক শিক্ষক অ্যাকাউন্ট নয়।
...
- পেমেন্ট কাউন্টার শুধু `payment.html`-এ। শিক্ষার্থী লগইন পেজে পেমেন্ট ট্যাব বা শর্টকাট নেই।
