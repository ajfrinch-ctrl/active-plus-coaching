...
`admin.html` খুললে এডমিন এন্ট্রি স্ক্রিন দেখা যায়। ইউজারনেম **`admin.apc`**, পাসওয়ার্ড **`Apc@2026`**। এক ক্লিকে ঢোকা বা আগে থেকে লেখা পাসওয়ার্ড নেই। “এই ডিভাইসে মনে রাখুন” চেক থাকলে সেশন ৯০ দিন থাকে। শিক্ষার্থী লগইন পেজে আলাদা কোনো স্টাফ ট্যাব বা লিংক নেই, কিন্তু একই লগইন ফর্মে `admin.apc` ও পাসওয়ার্ড দিলে সরাসরি এই প্যানেল খুলে যায় (সেশন আগেই জমা হয়); `admin.html` সরাসরি খুলেও লগইন করা যায়।
...
- **একই লগইন পেজ থেকেও প্রবেশ** — শিক্ষার্থী লগইন ফর্মে কাউন্টারের ইউজারনেম **`payment.apc`** ও পাসওয়ার্ড **`Apc@2026`** দিলে সেশন জমা হয়ে সরাসরি ডেস্ক খোলে (`payment.html` নিজেও এন্ট্রি ফর্ম দেখায়)। ভুল হলে বাংলা ত্রুটি-বার্তা। “এই ডিভাইসে মনে রাখুন” চেক থাকলে সেশন ৯০ দিন, না হলে ট্যাব-সেশন। সেশন থাকলে ডেস্ক সরাসরি খোলে।
