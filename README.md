...
`admin.html` খুললে এডমিন এন্ট্রি স্ক্রিন দেখা যায়। ইউজারনেম **`admin.apc`**, পাসওয়ার্ড **`Apc@2026`**। এক ক্লিকে ঢোকা বা আগে থেকে লেখা পাসওয়ার্ড নেই। “এই ডিভাইসে মনে রাখুন” চেক থাকলে সেশন ৯০ দিন থাকে। শিক্ষার্থী লগইন পেজ থেকে লিংক আছে, কিন্তু সেখান থেকে অটো-লগইন হয় না।
...
`teacher.html` খুলুন অথবা শিক্ষার্থী লগইন পেজ থেকে যান। ইউজারনেম **`teacher.apc`**, পাসওয়ার্ড **`Apc@2026`**। এক ক্লিকে প্রবেশ নেই। ডেটা এই ব্রাউজারে থাকে; এটি সার্ভার-ভিত্তিক শিক্ষক অ্যাকাউন্ট নয়।
